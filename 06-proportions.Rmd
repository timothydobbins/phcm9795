...
#### Output: 95% confidence interval for the prevalence of scabies using normal approximation to the binomial distribution {-}
...
#### Output: 95% confidence interval for prevalence of scabies using the Wilson method {-}
...
#### Output: z-test and binomial test for prevalence of smoking {-}
...
```{r ee-fig-rct, echo=FALSE, out.width = "75%", fig.cap="The design of a randomised controlled trial [Figure 4.1, Essential Epidemiology]"}
...
```{r ee-fig-cohort, echo=FALSE, out.width = "75%", fig.cap="The design of a cohort study [Figure 4.2, Essential Epidemiology]"}
...
```{r ee-fig-cc, echo=FALSE, out.width = "75%", fig.cap="The design of a case-control trial [Figure 4.3, Essential Epidemiology]"}
...
```{r ee-fig-cs, echo=FALSE, out.width = "75%", fig.cap="The design of a cross-sectional study [Figure 4.4, Essential Epidemiology]"}
...
#### Output: Relative risk and 95% CI from the cs command in Stata
```{r, echo=TRUE, eval=FALSE, highlight=FALSE}
                 | Group                  |
