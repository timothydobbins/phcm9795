...
```{r fig1-1, echo=FALSE, out.width = "400pt", fig.cap="Leading cause of death, by sex, 2016"}
...
```{r fig1-2, echo=FALSE, out.width = "400pt", fig.cap="Characteristics of the sample of prisoners from the NPHDC"}
...
```{r fig-prison-education, echo=FALSE, out.width = "400pt", fig.cap="Highest level of completed education in prison entrants and the general community"}
...
```{r fig-1-5, echo=FALSE, fig.cap="Prostate cancer age-standardised incidence and mortality rates (per 100,000), NSW, 1972-2014"}
