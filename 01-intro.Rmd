...
The following table, from the Australia’s health 2018 report, presents the leading causes of death, by sex in 2016 ^[This is Table S3.2.1 in the Australia’s health 2018 report]. The information from the table was also presented as a visualisation / infographic, demonstrating a simplistic, yet valuable way of presenting data and enabling comparison of causes of death for males and females. Noting that the leading cause of death for males in 2016 was coronary heart disease and, dementia and Alzheimer disease for females.

```{r tab-1-1, echo=FALSE}
tab1_1 <- tibble::tribble(
  ~Rank,	~`Leading causes of death`,	~Males, ~Females,
  1, "Coronary heart disease",	10870, 8207,
  2, "Dementia and Alzheimer disease",	4679,	8447,
  3, "Cerebrovascular disease",	4239,	6212,
  4, "Lung cancer",	5023, 3387,
  5, "COPD",	3903,	3309,
  NA,	"Total",	81867,	76637
  )


huxtable::huxtable(tab1_1) %>%
  set_align(everywhere, c(3,4), ".") %>% 
  theme_article() %>% 
  set_width(0.95) %>% 
  merge_repeated_rows() %>% 
  set_number_format(everywhere, c(3,4), fmt_pretty()) %>% 
  set_caption("Leading causes of death, by sex, 2016")
```
...
```{r fig1-1, echo=FALSE, out.width = "66%", fig.cap="Leading cause of death, by sex, 2016"}
...
```{r fig1-2, echo=FALSE, out.width = "66%", fig.cap="Characteristics of the sample of prisoners from the NPHDC"}
...
```{r fig-prison-education, echo=FALSE, out.width = "66%", fig.cap="Highest level of completed education in prison entrants and the general community"}
...
```{r fig-1-1, echo=FALSE, out.width = "75%", fig.cap="Bar graph of stage of disease from PBC study"}
...
```{r fig-1-2, echo=FALSE, out.width = "75%", fig.cap="Bar graph of stage of disease by sex from PBC study"}
...
```{r fig-1-3, echo=FALSE, out.width = "75%", fig.cap="Stacked bar graph of stage of disease by sex from PBC study"}
...
```{r fig-1-4, echo=FALSE, out.width = "75%", fig.cap="Relative frequency of sex within stage of disease from PBC study"}
...
```{r fig-1-5, echo=FALSE, out.width="66%", fig.cap="Prostate cancer age-standardised incidence and mortality rates (per 100,000), NSW, 1972-2014"}
...
```{r fig-1-6, echo=FALSE, out.width = "75%", fig.cap="Histogram of age (left) and serum bilirubin (right) from PBC study data"}
...
```{r fig-1-7, echo=FALSE, out.width = "75%", fig.cap="Box plot of age (left) and serum bilirubin (right) from PBC study data"}
knitr::include_graphics(here::here("img", "mod01", "hist-symmetric-skewed.png"))
```
...
| Summary statistic                       | Guideline (reference)                                                                              |     Example                             |
|-----------------------------------------|----------------------------------------------------------------------------------------------------|-----------------------------------------|
...
| Percentage                              | Percentages do not need to be given with more than one decimal place at most. When the sample size is less than 100, no decimal places should be given (Altman) |  "Large" (n>=100) studies: 0.7%, 3.4%, 75.5%. "Small" (n<100) studies: 1%, 3%, 89% |
