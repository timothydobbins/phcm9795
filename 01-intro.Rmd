...
```{r fig-1-1, echo=FALSE, fig.cap="Bar graph of stage of disease from PBC study"}
...
```{r fig-1-2, echo=FALSE, fig.cap="Bar graph of stage of disease by sex from PBC study"}
...
```{r fig-1-3, echo=FALSE, fig.cap="Stacked bar graph of stage of disease by sex from PBC study"}
...
```{r fig-1-4, echo=FALSE, fig.cap="Relative frequency of sex within stage of disease from PBC study"}
...
```{r fig-1-6, echo=FALSE, fig.cap="Histogram of age (left) and serum bilirubin (right) from PBC study data"}
...
```{r fig-1-7, echo=FALSE, fig.cap="Box plot of age (left) and serum bilirubin (right) from PBC study data"}
knitr::include_graphics(here::here("img", "mod01", "hist-symmetric-skewed.png"))
```
