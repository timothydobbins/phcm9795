...
```{r , echo=FALSE, out.width = "66%", fig.cap="Graph editor button on Stata for Windows"}
knitr::include_graphics(here::here("img", "mod01", "stata", "edit-04.png"))
```

```{r , echo=FALSE, out.width = "66%", fig.cap="Graph editor button on Stata for MacOS"}
...
```{r , echo=FALSE, out.width = "66%", fig.cap="Graph editor window: Windows"}
knitr::include_graphics(here::here("img", "mod01", "stata", "edit-06.png"))
```

```{r , echo=FALSE, out.width = "66%", fig.cap="Graph editor window: MacOS"}
