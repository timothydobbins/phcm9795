...
[@kirkwood_sterne01a]; Chapter 8.

[@bland15b]; Sections 9.1 to 9.7; Sections 10.1 and 10.2.
...
```{r practical-importance, echo=FALSE, out.width = "400pt", fig.cap="Statistical significance vs. clinical importance (Source: Armitage P, Berry G, Matthews JNS. (2001)"}
knitr::include_graphics(here::here("img", "mod4", "practical-vs-statistical-sig.png"))
```
...
```{r cis-overlapping-null, echo=FALSE, out.width = "400pt", fig.cap="Using 95% CIs as informal hypothesis tests"}
knitr::include_graphics(here::here("img", "mod4", "cis-overlapping-null.png"))
```
...
```{r two-tailed-test, echo=FALSE, out.width = "400pt", fig.cap="P-value for a 2-tailed test"}
knitr::include_graphics(here::here("img", "mod4", "two-tailed-test.png"))
```
...
```{r one-tailed-tests, echo=FALSE, out.width = "400pt", fig.cap="P-value for 1-tailed tests"}
knitr::include_graphics(here::here("img", "mod4", "one-tailed-tests.png"))
```
