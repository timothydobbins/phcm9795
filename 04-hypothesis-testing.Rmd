...
```{r cis-overlapping-null, echo=FALSE, out.width = "66%", fig.cap="Using 95% CIs as informal hypothesis tests"}
...
```{r one-tailed-tests, echo=FALSE, out.width = "66%", fig.cap="P-value for 1-tailed tests"}
