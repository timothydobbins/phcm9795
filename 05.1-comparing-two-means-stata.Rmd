...
To obtain the histograms in Figure 5.1, go to **Graphics > Histogram**. Select `birthweight` as the **Variable** in the **Main** tab. Next go to the **By** tab, tick **Draw subgraphs for unique values of variable** and select `gender` as the **variable** as shown below:

```{r hist-by-1, echo=FALSE, out.width = "400pt",}
...
```{r hist-by-2, echo=FALSE, out.width = "400pt",}
...
```{r box-by-1, echo=FALSE, out.width = "400pt",}
...
```{r ttest-1, echo=FALSE, out.width = "400pt",}
knitr::include_graphics(here::here("img", "mod05", "stata", "ttest-1.png"))
```

Click **OK** or **Submit** to obtain Output 5.3. 
...
```{r ttest-2, echo=FALSE, out.width = "400pt",}
...
```{r ttest-3, echo=FALSE, out.width = "400pt",}
...
```{r ttest-4, echo=FALSE, out.width = "400pt",}
knitr::include_graphics(here::here("img", "mod05", "stata", "ttest-4.png"))
```

Click **Submit** or **OK**. The output will look like Output 5.4 in the course notes. 
