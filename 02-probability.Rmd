...
```{r fig-2-1, echo=FALSE, out.width = "75%", fig.cap="Distribution of diastolic blood pressure, 2017–18 Australian Bureau of Statistics National Health Survey"}
knitr::include_graphics(here::here("img", "mod2", "dbp.png"))
```
Source: https://www.aihw.gov.au/reports/risk-factors/high-blood-pressure/contents/high-blood-pressure (accessed March 2021)

```{r fig-2-2, echo=FALSE, out.width = "75%", fig.cap="Distribution of male and female heights"}
knitr::include_graphics(here::here("img", "mod2", "heights.png"))
```
...
```{r fig-2-3, echo=FALSE, out.width = "75%", fig.cap="Characteristics of a Normal distribution"}
knitr::include_graphics(here::here("img", "mod2", "normal-curve.png"))
```
...
```{r fig-2-4, echo=FALSE, out.width = "75%", fig.cap="Obtaining a probability from a table of Standard Normal distribution"}
knitr::include_graphics(here::here("img", "mod2", "z-table-extract.png"))
```
...
```{r fig-2-5, echo=FALSE, out.width = "75%", fig.cap="Area under the Standard Normal curve (as probability) for Z > 1.1"}
knitr::include_graphics(here::here("img", "mod2", "z-dist-shaded.png"))
```
...
```{r fig-2-6, echo=FALSE, out.width = "80%", fig.cap="Histogram and boxplot of weight of 30 students attending a gym"}
knitr::include_graphics(here::here("img", "mod2", "weights-hist-boxplot.png"))
```
...
```{r fig-2-7, echo=FALSE, out.width = "80%", fig.cap="Histogram and boxplot of length of stay"}
knitr::include_graphics(here::here("img", "mod2", "los-hist-boxplot.png"))
```
