...
```{r fig-2-6, echo=FALSE, out.width = "66%", fig.cap="Histogram and boxplot of weight of 30 students attending a gym"}
...
```{r fig-2-7, echo=FALSE, out.width = "66%", fig.cap="Histogram and boxplot of length of stay"}
