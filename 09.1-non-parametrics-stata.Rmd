...
```{r mod09-ranksum, echo=FALSE, out.width = "75%",}
...
```{r mod09-signrank, echo=FALSE, out.width = "75%",}
...
```{r mod09-spearman, echo=FALSE, out.width = "75%",}
...
```{r mod09-kendall, echo=FALSE, out.width = "75%",}
