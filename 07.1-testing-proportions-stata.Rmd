...
```{r tabulate2-1, echo=FALSE, out.width = "500pt"}
...
```{r tabi-1, echo=FALSE, out.width = "500pt"}
...
```{r tabulate2-2, echo=FALSE, out.width = "500pt"}
...
```{r tabulate2-3, echo=FALSE, out.width = "500pt"}
knitr::include_graphics(here::here("img", "mod07", "stata", "tabulate2-3.png"))
```

[Command: `tab2 drugb druga , cell`]

Click **OK** or **Submit** to obtain the output for Table 7.2.

```{r, echo=TRUE, eval=FALSE, highlight=FALSE}
-> tabulation of drugb by druga  
...
+-----------------+
  ...
  Response |  Response to Drug A
 to Drug B |        No        Yes |     Total
-----------+----------------------+----------
        No |         5         20 |        25 
           |      8.33      33.33 |     41.67 
-----------+----------------------+----------
...
```{r mcc-1, echo=FALSE, out.width = "500pt"}
knitr::include_graphics(here::here("img", "mod07", "stata", "mcc-1.png"))
```

[Command: `mcc drugb druga`]
 
Click **OK** or **Submit** when you are done to obtain Output 7.3.
