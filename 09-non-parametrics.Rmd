...
```{r mod09-los, echo=FALSE, out.width = "400pt", fig.cap="Length of hospital stay for 132 patients"}
...
```{r mod09-lnlos, echo=FALSE, out.width = "400pt", fig.cap="istribution of log transformed (length of stay + 1)"}
